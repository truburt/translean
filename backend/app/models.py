...
class AppConfig(Base, TimestampMixin):
    ...
    pipeline_mode: Mapped[str] = mapped_column(String(50), nullable=False, default="legacy_whisper_ollama")
    gemma_base_url: Mapped[str] = mapped_column(String(255), nullable=False, default="http://localhost:8010")
    gemma_model: Mapped[str] = mapped_column(String(255), nullable=False, default="google/gemma-4-E4B-it")
    gemma_keep_alive_seconds: Mapped[int] = mapped_column(Integer, nullable=False, default=900)
