...
export const dom = {
    ...
    pipelineModeInput: document.getElementById('pipeline-mode'),
    gemmaEndpointInput: document.getElementById('gemma-endpoint'),
    gemmaModelInput: document.getElementById('gemma-model'),
    gemmaKeepAliveInput: document.getElementById('gemma-keep-alive'),
